...
logging.basicConfig(
    filename=f"training logs/exp2_train_{date.today().strftime('%d_%m')}.log",
    level=logging.INFO,
...
#dumping hist_dict
path_to_hist_dict = f"{Path(os.getcwd()).parents[0]}/data/exp_2_hist_dict_{date.today().strftime('%d_%m')}.pkl"
